...
import { aboutUsApi, type AboutUsResponse } from "@/lib/aboutUs/api";
import { ourTeamApi, type OurTeamResponseDto } from "@/lib/ourTeam/api";

async function getAboutUsData(): Promise<AboutUsResponse[]> {
  try {
...
async function getOurTeamData(): Promise<OurTeamResponseDto[]> {
  try {
    const ourTeamData = await ourTeamApi.getAllOurTeam();
    return ourTeamData;
  } catch (error) {
    console.error("Failed to fetch our team data:", error);
    return [];
  }
}

export default async function About() {
  const [aboutUsData, ourTeamData] = await Promise.all([
    getAboutUsData(),
    getOurTeamData(),
  ]);

  const featureAboutUs = aboutUsData.length > 0 ? aboutUsData[0] : null;
  const featuredOurTeam = ourTeamData.length > 0 ? ourTeamData[0] : null;
            ...
            <div className="post-loop-grid">
              <div className="container">
                ...
                <div className="row mt-70">
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12">
                    <h3 className="mt-15">
                      {featureAboutUs?.servicesSectionTitle || ""}
                    </h3>
                    <div className="mt-20">
                      ...
                      <div className="card-grid-4 text-center hover-up">
                        ...
                        <div className="card-grid-4-info">
                          ...
                          <div className="rate-reviews-small pt-5">
                            ...
                            <span className="ml-10 color-text-mutted font-xs"></span>
                          </div>
